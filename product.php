...
foreach($list_array as $element) {
    $array['price'] = $element->find('div.card > div.card-body > h4.card-title > a[data-name]',0)->attr['data-name'];
    $array['price_old'] = $url.$element->find('div.card > div.card-body > h4.card-title > a[data-name]',0)->href;
